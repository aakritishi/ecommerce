<?php
    ...
    if(isset($_POST['insert_product'])) {
        ...
        $image_extension2 = pathinfo($product_image2, PATHINFO_EXTENSION);
        $image_extension3 = pathinfo($product_image3, PATHINFO_EXTENSION);
        ...
        if (empty($product_title) || empty($description) || empty($product_keywords) || empty($product_category) ||
            empty($product_brand) || empty($product_price) || empty($product_image1) || empty($product_image2) ||
            ...
            exit();
                  ...
                  !in_array(strtolower($image_extension2), $allowed_extensions) ||
                  !in_array(strtolower($image_extension3), $allowed_extensions)) {
            ...
            $stmt = $con->prepare("INSERT INTO `products` 
                ...
                VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, NOW(), ?)");
            $stmt->bind_param("sssiisssss", $product_title, $description, $product_keywords, $product_category, 
                              $product_brand, $product_image1, $product_image2, $product_image3, $product_price, $product_status);
