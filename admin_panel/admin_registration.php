...
<?php
    if (isset($_POST['admin_register'])) {
        ...
        $select_query = "SELECT * FROM `admin_tables` WHERE admin_name = ? OR admin_email = ?";
        ...
        if ($rows_count > 0) {
            ...
            // Insert new admin
            $insert_query = "INSERT INTO `admin_tables` (admin_name, admin_email, admin_password) VALUES (?, ?, ?)";
